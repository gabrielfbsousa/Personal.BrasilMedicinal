 ...
 * @author gabriel
 */
public class NorthButton implements IRegionButton {
    ...
    public void installButton(MainFrame application) throws IOException {
        ...
        JLabel lblNewLabel = application.getjLabel1();
        JPanel panel = application.getjPanel2();
        final ImageIcon regular = new ImageIcon(getClass().getResource("/resources/north/norte-sozinho.png"));
        final ImageIcon hovering = new ImageIcon(getClass().getResource("/resources/north/norte-sozinho.png"));
        final ImageIcon clicking = new ImageIcon(getClass().getResource("/resources/north/norte-branco.png"));

        //File file = new File("/home/gabriel/NetBeansProjects/MedicionalBrazil/src/resources/north/norte-branco.png");
        final BufferedImage img = ImageIO.read(getClass().getResource("/resources/north/norte-branco.png"));
    ...
    public void addContent(JPanel pnl) throws IOException {
        ...
        if (menuRegionalMedicine) {
            ...
            InputStream IS = ProjectController.class.getResourceAsStream("/resources/north/norte-info.png");
    ...
    public JButton createNorthButton() {
        ...
        newButton.setIcon(new javax.swing.ImageIcon(getClass().getClassLoader().getResource("resources/north/planta-1.png"))); // NOI18N
            ...
            newButton.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                   ...
                   application.getjPanel2().setLayout(new BorderLayout());  
                    ...
                    InputStream IS = NortheastButton.class.getResourceAsStream("/resources/north/estrutura-1.png");
                   ...
                   //-------------------------------------- Criar clique
                    labelImage.addMouseListener(new MouseAdapter() {
                        public void mouseClicked(MouseEvent e) {
                            ...
                            application.getjPanel2().removeAll();
                    application.getjPanel2().setLayout(new BorderLayout());
                     InputStream IS = NortheastButton.class.getResourceAsStream("/resources/north/Acido-hardwickico.png");
                    Image image = null;
                    try {
                        image = ImageIO.read(IS);
                    } catch (IOException ex) {
    ...
    public JButton createSouthButton() {
        javax.swing.JButton newButton = new JButton();
        newButton.setIcon(new javax.swing.ImageIcon(getClass().getClassLoader().getResource("resources/north/planta-2.png"))); // NOI18N
        newButton.setFocusable(false);
        newButton.setBorderPainted(false);
        newButton.setOpaque(false);
        newButton.setContentAreaFilled(false);
        ...
        if (newButton != null) {
            newButton.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    ...
                    InputStream IS = NortheastButton.class.getResourceAsStream("/resources/north/estrutura-2.png");
                    ...
                    labelImage.addMouseListener(new MouseAdapter() {
                        public void mouseClicked(MouseEvent e) {
                            ...
                            application.getjPanel2().removeAll();
                    application.getjPanel2().setLayout(new BorderLayout());
                     InputStream IS = NortheastButton.class.getResourceAsStream("/resources/north/Cajucarinolida.png");
                    Image image = null;
                    try {
                        image = ImageIO.read(IS);
                    } catch (IOException ex) {
