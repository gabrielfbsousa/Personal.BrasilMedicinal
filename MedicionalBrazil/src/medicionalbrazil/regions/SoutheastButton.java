 ...
 * @author gabriel
 */
public class SoutheastButton implements IRegionButton {
    ...
    private MouseAdapter northButtonAdapter;
    private MouseAdapter southButtonAdapter;
    ...
    public void installButton(MainFrame application) throws IOException {
        ...
        JLabel lblNewLabel = application.getjLabel4();
        JPanel panel = application.getjPanel2();
        ImageIcon regular = new ImageIcon(getClass().getResource("/resources/southeast/sudeste-sozinho.png"));
        ImageIcon hovering = new ImageIcon(getClass().getResource("/resources/southeast/sudeste-sozinho.png"));
        ImageIcon clicking = new ImageIcon(getClass().getResource("/resources/southeast/sudeste-branco.png"));
    ...
    public void addContent(JPanel pnl) throws IOException {
        ...
        if (menuRegionalMedicine) {
            ...
            InputStream IS = ProjectController.class.getResourceAsStream("/resources/southeast/sudeste-info.png");
    ...
    public JButton createNorthButton() {
        ...
        newButton.setIcon(new javax.swing.ImageIcon(getClass().getClassLoader().getResource("resources/southeast/planta-1.png"))); // NOI18N
        ...
        if (newButton != null) {
            newButton.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    application.getjPanel2().removeAll();
                    application.getjPanel2().setLayout(new BorderLayout());
                    InputStream IS = NortheastButton.class.getResourceAsStream("/resources/southeast/estrutura-1.png");
                    Image image = null;
                    try {
                   ...
                   //-------------------------------------- Criar clique
                    labelImage.addMouseListener(new MouseAdapter() {
                        public void mouseClicked(MouseEvent e) {
                            ...
                            application.getjPanel2().removeAll();
                    application.getjPanel2().setLayout(new BorderLayout());
                     InputStream IS = NortheastButton.class.getResourceAsStream("/resources/southeast/Astilbina.png");
                    Image image = null;
                    try {
                        image = ImageIO.read(IS);
                    } catch (IOException ex) {
    ...
    public JButton createSouthButton() {
        javax.swing.JButton newButton = new JButton();
        newButton.setIcon(new javax.swing.ImageIcon(getClass().getClassLoader().getResource("resources/southeast/planta-2.png"))); // NOI18N
        newButton.setFocusable(false);
        newButton.setBorderPainted(false);
        newButton.setOpaque(false);
        newButton.setContentAreaFilled(false);
        ...
        if (newButton != null) {
            newButton.addActionListener(new java.awt.event.ActionListener() {
                public void actionPerformed(java.awt.event.ActionEvent evt) {
                    ...
                    InputStream IS = NortheastButton.class.getResourceAsStream("/resources/southeast/estrutura-2.png");
                    ...
                    labelImage.addMouseListener(new MouseAdapter() {
                        public void mouseClicked(MouseEvent e) {
                            ...
                            application.getjPanel2().removeAll();
                    application.getjPanel2().setLayout(new BorderLayout());
                     InputStream IS = NortheastButton.class.getResourceAsStream("/resources/southeast/Cinarina.png");
                    Image image = null;
                    try {
                        image = ImageIO.read(IS);
                    } catch (IOException ex) {
